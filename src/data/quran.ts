...
export interface Ayah {
  ...
  text: string;
  translation?: string | { ku?: string; en?: string };
  tafsir?: string | { ar?: string; ku?: string; en?: string };
  juz?: number;
  page?: number;
  hizbQuarter?: number;
}
  ...
  1: [
    {
      ...
      translation: { ku: "بەناوی خودای بەخشندەی میهرەبان", en: "In the name of Allah, the Entirely Merciful, the Especially Merciful." },
      tafsir: { ar: "بدأت باسم الله مستعيناً به", ku: "بەناوی خوداوە دەست پێ دەکەم و داوای یارمەتی لێ دەکەم", en: "I start by the name of Allah, seeking His help." }
    },
    {
      number: 2,
      text: "الْحَمْدُ لِلَّهِ رَبِّ الْعَالَمِينَ",
      translation: { ku: "سوپاس و ستایش بۆ خودای پەروەردگاری جیهانیان", en: "All praise is [due] to Allah, Lord of the worlds -" },
      tafsir: { ar: "الثناء على الله بكلمات الشكر", ku: "سوپاس و پیاهەڵدان تەنها بۆ خودایە", en: "Praise and thanks to Allah alone." }
    }
  ],
  110: [
    {
      ...
      translation: { ku: "کاتێک سەرکەوتنی خودا و فەتح هات", en: "When the victory of Allah has come and the conquest," },
      tafsir: { ar: "إذا تم لك النصر يا محمد على كفار قريش", ku: "کاتێک سەرکەوتنت بەسەر بێبڕواکاندا بۆ دابین کرا", en: "When victory is achieved for you, O Muhammad." }
    }
  ],
  112: [
    {
      ...
      translation: { ku: "بڵێ: ئەو خودایە و تاک و تەنهایە", en: "Say, \"He is Allah, [who is] One," },
      tafsir: { ar: "الله الواحد الأحد الذي لا شريك له", ku: "خودا تاک و تەنهایە و هیچ هاوبەشێکی نییە", en: "Allah is the One and Only, without any partner." }
    }
  ]
};
